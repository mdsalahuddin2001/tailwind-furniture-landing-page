...
const Newsletter = () => {
  ...
  return (
    <section className="section bg-newsletter min-h-[490px] bg-no-repeat bg-cover bg-center">
      <div className="container mx-auto flex justify-center lg:justify-end">
        <div className="w-full max-w-[558px] text-center lg:text-left text-white">
          <h2 className="text-4xl text-white font-semibold max-w-[350px] mx-auto lg:mx-0 mb-5 leading-normal">
            {title}
          </h2>
